...
function Testimonials() {
  ...
  //   enterActive: "transition ease-in-out duration-700 transform order-first",
  //   enter: "opacity-0 -translate-y-8",
  //   enterDone: "opacity-100 translate-y-0",
  //   exitActive: "transition ease-in-out duration-300 transform absolute",
  //   exit: "opacity-100 translate-y-0",
  //   exitDone: "opacity-0 translate-y-8",
  // };
  ...
  function handleActiveChange(index: any) {
    setActive(index);
    stopAutorotate();
  }
  ...
  useEffect(() => {
    ...
    setAutorotateInterval(intervalId);

    return () => {
      clearInterval(intervalId);
    };
  }, [items.length, autorotateTiming]);
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto">
            {/* Carousel  */}
            <div className="relative mt-20  h-96" data-aos="zoom-y-out">
              {/* Testimonials */}
                ...
                {items.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="text-gray-600">
                      <span>{item.role}</span>{" "}
                      <span className="text-blue-600">{item.team}</span>
                    </div>
                  </Transition>
                ))}
              </div>
              ...
              <div className="absolute inset-0 flex items-center justify-between">
                <button
                  className="w-16 h-16 p-1 flex items-center justify-center bg-white rounded-full border border-gray-200 shadow-md hover:shadow-lg transform -translate-x-2 md:-translate-x-1/2"
                  onClick={() => {
                    handleActiveChange(
